...
**Design phase.** The Laravel application is not yet scaffolded — this repository currently contains design documents, specifications, and the UI design system only. Implementation starts with Phase 1 ([Chat-to-query backend](docs/spec/01-phase1-backend.md)).
...
4. [Phase 1 Backend Spec](docs/spec/01-phase1-backend.md) — the first implementation target
